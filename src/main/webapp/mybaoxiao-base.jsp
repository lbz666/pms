	...
	<script type="text/javascript">
		function queryLst() {
			...
			if (!reg.test(pageNo)){
			    ...
			    window.location.href="${pageContext.request.contextPath}/bx/myList?pageNum="+pageNo + "${queryStr}";
			}
...
<tr align="right" bgcolor="#EEF4EA">
	<td height="36" colspan="12" align="center">
		<div>
			<a href="${pageContext.request.contextPath}/bx/myList?pageNum=1${queryStr}">首页</a>
			<a href="${pageContext.request.contextPath}/bx/myList?pageNum=${page.pageNum - 1}${queryStr}">上一页</a>
			<c:forEach items="${page.navigatepageNums}" var="pageNum">
				...
				<c:if test="${pageNum != page.pageNum}">
					<a href="${pageContext.request.contextPath}/bx/myList?pageNum=${pageNum}${queryStr} ">${pageNum}</a>
				</c:if>
			</c:forEach>
			<a href="${pageContext.request.contextPath}/bx/myList?pageNum=${page.pageNum + 1}${queryStr}">下一页</a>
			<a href="${pageContext.request.contextPath}/bx/myList?pageNum=${page.pages}${queryStr}">末页</a>
