...
<link rel="stylesheet" type="text/css" href="skin/css/main.css" />
	...
	<script type="text/javascript">
		$(function () {
			$.ajax({
				type:"GET",
				url:"${pageContext.request.contextPath}/notice/latestNoticeList",
				success:function (msg) {
					if(msg.map.statusCode == 200){
					    $(msg.map.notices).each(function (index,item) {
		    ...
		    $.ajax({
               type:"GET",
                ...
                success:function (msg) {
                    ...
                    $("#content").text(msg.remark).css({"font-size":"20px"});
                    $("#showdiv").show();
...
<body leftmargin="8" topmargin='8'>
	...
	<div id="showdiv" style="width: 60%; margin: 0 auto; height:500px; border: 1px solid #999; display: none; position: absolute; top: 20%; left: 20%; z-index: 3; background: #fff">
		<!-- 标题 -->
		<div id="ntitle" style="background: #F8F7F7; width: 100%; height: 2rem; font-size: 0.65rem; line-height: 4rem; border: 1px solid #999; text-align: center;" >
